...
import nex
from nex.stock.get_item_details import ItemDetailsCtx, _get_item_tax_template
...
def get_income_account(doctype, txt, searchfield, start, page_len, filters):
	from nex.controllers.queries import get_match_cond
...
def get_filtered_dimensions(doctype, txt, searchfield, start, page_len, filters, reference_doctype=None):
	from nex.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
