...
import nex
from nex.stock.serial_batch_bundle import get_batches_from_bundle
from nex.stock.serial_batch_bundle import get_serial_nos as get_serial_nos_from_bundle
...
def get_returned_serial_nos(child_doc, parent_doc, serial_no_field=None, ignore_voucher_detail_no=None):
	from nex.stock.doctype.serial_no.serial_no import (
		get_serial_nos as get_serial_nos_from_serial_no,
	)
	from nex.stock.serial_batch_bundle import get_serial_nos
...
def get_available_batch_qty(parent_doc, batch_no, warehouse):
	from nex.stock.doctype.batch.batch import get_batch_qty
