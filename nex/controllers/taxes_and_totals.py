...
import nex
from nex.accounts.doctype.journal_entry.journal_entry import get_exchange_rate
from nex.accounts.doctype.pricing_rule.utils import get_applied_pricing_rules
from nex.controllers.accounts_controller import (
	validate_conversion_rate,
	validate_inclusive_tax,
	validate_taxes_and_charges,
)
from nex.deprecation_dumpster import deprecated
from nex.stock.get_item_details import ItemDetailsCtx, _get_item_tax_template, get_item_tax_map
...
class calculate_taxes_and_totals:
	...
	def validate_conversion_rate(self):
		...
		company_currency = nex.get_company_currency(self.doc.company)
...
from nex.deprecation_dumpster import (
