...
from nex.accounts.party import render_address
from nex.controllers.accounts_controller import get_taxes_and_charges
from nex.controllers.sales_and_purchase_return import get_rate_for_return
from nex.controllers.stock_controller import StockController
from nex.stock.doctype.item.item import set_item_default
from nex.stock.get_item_details import get_bin_details, get_conversion_factor
from nex.stock.utils import get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from nex.accounts.party import _get_party_details
			...
			from nex.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from nex.controllers.buying_controller import validate_item_type
