...
from nex.accounts.doctype.payment_entry.payment_entry import get_payment_entry
from nex.accounts.doctype.payment_entry.test_payment_entry import create_payment_entry
from nex.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
from nex.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
from nex.accounts.party import get_party_account
from nex.buying.doctype.purchase_order.test_purchase_order import prepare_data_for_internal_transfer
from nex.projects.doctype.project.test_project import make_project
from nex.stock.doctype.item.test_item import create_item
...
class TestAccountsController(IntegrationTestCase):
	...
	def test_16_internal_transfer_at_arms_length_price(self):
		from nex.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_purchase_invoice
		from nex.stock.doctype.warehouse.test_warehouse import create_warehouse
	...
	def setup_dimensions(self):
		# create dimension
		from nex.accounts.doctype.accounting_dimension.test_accounting_dimension import (
			create_dimension,
		)
