...
from nex.controllers.item_variant import copy_attributes_to_variant, make_variant_item_code
from nex.stock.doctype.item.test_item import set_item_variant_settings
from nex.stock.doctype.quality_inspection.test_quality_inspection import (
