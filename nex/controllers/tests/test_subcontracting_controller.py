...
from nex.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
from nex.controllers.subcontracting_controller import (
	get_materials_from_supplier,
	make_rm_stock_entry,
)
from nex.manufacturing.doctype.production_plan.test_production_plan import make_bom
from nex.stock.doctype.item.test_item import make_item
from nex.stock.doctype.serial_and_batch_bundle.test_serial_and_batch_bundle import (
	make_serial_batch_bundle,
)
from nex.stock.doctype.serial_no.serial_no import get_serial_nos
from nex.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
from nex.subcontracting.doctype.subcontracting_order.subcontracting_order import (
...
def get_subcontracting_order(**args):
	from nex.subcontracting.doctype.subcontracting_order.test_subcontracting_order import (
