...
// frappe.ui.form.on("Document Tracker Logs", {
// 	refresh(frm) {
...
frappe.ui.form.on('Document Tracker Logs', {
    onload: function(frm) {
        setTimeout(() => {
            $(".ql-editor").css("font-family", "'Palatino Linotype', 'Palatino', serif");
            $(".mce-content-body").css("font-family", "'Palatino Linotype', 'Palatino', serif");
        }, 1000); // Delay to ensure the editor is loaded
    }
});
